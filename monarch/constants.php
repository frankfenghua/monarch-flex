...
define('CRAWL_MAX_TOPLEVEL_PAGES_TO_CRAWL', 2); // the breadth of pages on the top level to crawl.
define('CRAWL_THROTTLE', 3);                    // number of seconds to delay between downloading each page

define('REGEX_ENGLISH_WORD', 'a-zA-Z');
...
define('REGEX_DOMAIN_SUFFIXES', 
	'com|net|info|org|me|tv|mobi|biz|us|ca|asia|ws|ag|am|at|be|cc|cn|de|eu|fm|fm|gs|jobs|jp|ms|nu|co|nz|tc|tw|idv|uk|vg');
